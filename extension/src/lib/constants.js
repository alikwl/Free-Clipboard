/**
 * FreeClipboard Extension - Constants & Configuration
...
// ============================================
// EXPORT (Universal Module Definition)
// ============================================

// For ES modules (service worker, popup)
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { FC_CONFIG, FC_PATTERNS, FC_ERRORS };
}

// For browser environment (content scripts)
if (typeof globalThis !== 'undefined') {
  globalThis.FC_CONFIG = FC_CONFIG;
  globalThis.FC_PATTERNS = FC_PATTERNS;
  globalThis.FC_ERRORS = FC_ERRORS;
}
